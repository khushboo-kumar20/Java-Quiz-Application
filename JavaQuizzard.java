...
public class JavaQuizzard extends JFrame implements ActionListener{
    
    JButton b1,b2;
    JTextField t1;
    
    JavaQuizzard(){
        setBounds(150, 100, 1200, 500); // dleft, dup, length, height
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("quizmasters/icons/login.jpeg"));
        JLabel l1 = new JLabel(i1);
        l1.setBounds(0, 0, 600, 500);
        add(l1);
        
        JLabel l2 = new JLabel("Java Quizzard");
    ...
    public static void main(String[] args) {
        new JavaQuizzard(); // Anonymous Object
    }
