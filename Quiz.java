...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String username){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("quizmasters/icons/quiz.jpg"));
        JLabel l1 = new JLabel(i1);
        l1.setBounds(0, 0, 1350, 300);
        add(l1);
        
        qno = new JLabel("");
        qno.setFont(new Font("Tahoma", Font.PLAIN, 24));
        qno.setBounds(100, 350, 40, 30);
        add(qno);
        ...
        submit.setBounds(1000, 550, 200, 30);
